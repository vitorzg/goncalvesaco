...
import br.com.goncalvesaco.ecommerce.infra.gateways.UserEntityMapper;
...
public class AppConfig {
    ...
    @Bean
    UserRepositoryGateway userGateway(UserRepository userRepository, UserEntityMapper userEntityMapper){
